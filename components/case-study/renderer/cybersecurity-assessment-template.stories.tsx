...
import cybersecurityTemplate from "@/templates/report_template/generated/cybersecurity_report_template/sample.json";
...
const templatePages = (cybersecurityTemplate.pages || []).map((page) =>
  normalizePage({ pageTitle: page.pageTitle, layout: page.layout as GenericBlock[] }),
);

const meta = {
  title: "Case Study/Templates/INALUM Cybersecurity Assessment",
