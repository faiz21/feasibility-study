...
export function CaseStudyOverview({
  ...
  return (
    <article
      className="overflow-hidden border border-foreground/10 bg-[var(--overview-background)] text-[var(--overview-text)]"
      style={themeStyle}
    >
      <section className="relative min-h-[420px] p-5 md:min-h-[520px] md:p-10">
        <div
          ...
          style={{
            ...
            backgroundImage:
              "radial-gradient(circle at 10% 90%, rgba(15, 23, 42, 0.08) 0%, transparent 40%), radial-gradient(circle at 85% 20%, rgba(15, 23, 42, 0.06) 0%, transparent 30%), repeating-linear-gradient(-22deg, rgba(15, 23, 42, 0.05) 0px, rgba(15, 23, 42, 0.05) 2px, transparent 2px, transparent 20px)",
          }}
        />

        <div className="relative z-10 w-full max-w-[430px] border border-white/15 bg-[var(--overview-primary)] text-white shadow-2xl">
