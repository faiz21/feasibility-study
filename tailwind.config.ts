  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        auth: {
          shellStart: "hsl(var(--auth-shell-start))",
          shellMid: "hsl(var(--auth-shell-mid))",
          shellEnd: "hsl(var(--auth-shell-end))",
          heroStart: "hsl(var(--auth-hero-start))",
          heroMid: "hsl(var(--auth-hero-mid))",
          heroEnd: "hsl(var(--auth-hero-end))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
