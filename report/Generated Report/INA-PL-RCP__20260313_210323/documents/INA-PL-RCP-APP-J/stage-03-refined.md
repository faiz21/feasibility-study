# Appendix J - KPIs and Performance Measures
...
This appendix summarizes KPI scope relevant to Rodding Plant [INA-PL-RCP].

## 2. KPI Inventory Summary

| Code | Name | Priority | Granularity | Owner |
| --- | --- | --- | --- | --- |
| INA-KPI-005 | Anode Genealogy Completion (%) | High | Daily | To validate |
| INA-KPI-012 | OEE (Availability/Performance/Quality) — Critical Lines | High | Daily | To validate |
| INA-KPI-017 | SCADA Critical Alarm Response Time (median minutes) | High | Shift | To validate |
| INA-KPI-018 | Historian Tag Data Completeness (%) | Med | Weekly | To validate |
| INA-KPI-019 | Preventive Maintenance Compliance (%) | High | Weekly | To validate |
| INA-KPI-020 | Maintenance Schedule Adherence (%) | High | Weekly | To validate |
| INA-KPI-022 | MTBF — Critical Assets (hours) | High | Monthly | To validate |
| INA-KPI-023 | MTTR — Critical Assets (hours) | High | Monthly | To validate |
