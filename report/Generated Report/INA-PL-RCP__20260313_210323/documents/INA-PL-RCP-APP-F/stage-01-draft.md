...
This appendix captures mobile-asset evidence linked to Rodding Plant [INA-PL-RCP].

## 2. Mobile Asset Inventory

| Code | Vehicle/Mobile Asset | Category | Typical Use | Energy/Fuel |
| --- | --- | --- | --- | --- |
| INA-VEH-RCP-001 | INA-VHT-MTC | Transport | Site note mentions “MTC weigher” under Rodding Plant; To validate — confirm vehicle identity and whether this is molten MTC vs anode transport movement. | To validate |
