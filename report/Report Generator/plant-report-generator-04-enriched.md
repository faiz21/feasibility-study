# Step 04 - Enriched Instruction Addendum

Global reference: `00-global-enriched-instruction.md`
Base schema: `plant-report-generator-enriched-base.schema.json`
Target schema: `plant-report-generator-04-enriched.schema.json`

## Intent
Produce report-ready transformed data for **Appendix C — Asset Scope: Equipment Inventory** with consultant-grade 360 analysis, maturity scoring (0-100 + 5-level label), executive narrative packaging, and visualization-ready chart definitions.

## Required Inputs
- Source instruction: `plant-report-generator-04.md`
- Source schema: `plant-report-generator-04.json`
...
- Preserve deterministic logic and stop conditions from Step 4 baseline artifacts.
...
- Equipment references unknown Process Group
- Bottleneck narrative lacks evidence linkage

## Output Contract
- Output object must validate against `plant-report-generator-04-enriched.schema.json`.
- `source_step` must be `4` and `report_profile.title` must be exactly `Appendix C — Asset Scope: Equipment Inventory`.
